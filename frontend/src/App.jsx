...
const horizons = [
  { key: "1d",  label: "1 Day",   subtitle: "Minute/Second-wise intraday forecast" },
...
function ForecastDashboard({ user, profile, theme, setTheme, onLogout }) {
  ...
  <h2>
    <span className="live-badge">LIVE</span> Multi-Horizon Forecasting
  </h2>
  <p>
    Search a company, select forecast horizons (1D, 15D, 30D), and view stacked linear model predictions generated by the backend.Test strategies using integrated paper trading.
  </p>
</div>
